...
const settings = React.lazy(() => import("./views/theme/settings/settings"));
...
const routes = [
  ...
  { path: "/theme/offers", name: "Offers", component: offers },
  { path: "/theme/refferals", name: "refferals", component: refferals },
